            ...
            >
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4 md:w-136 md:h-72 md:rounded-2xl">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-2 md:-mt-3 md:mb-6">
                      This Website
                    </div>
                    <div className="text-base text-white/70 pr-8 flex-grow sm:hidden md:text-sm">
                      You are still here and looking around, so it’s not too
                      bad, right? Feel free to reach out to me if you have any
            ...
            >
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4 md:w-136 md:h-72 md:rounded-2xl">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:hidden md:-mt-3 md:mb-3">
                      McMaster Room Booking
                    </div>
                    <div className="hidden text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-2 sm:block">
                      Room Booking
                    </div>
                    <div className="text-base text-white/70 pr-8 flex-grow sm:hidden md:text-sm">
                      A website to centralize and streamline the room booking
                      process for the buildings across the McMaster University
                      campus.
                    </div>
                    <div className="hidden text-base text-white/70 pr-8 flex-grow sm:text-xs sm:pr-0 sm:scale-75 sm:origin-top-left sm:block">
            ...
            >
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4 md:w-136 md:h-72 md:rounded-2xl">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-1 sm:hidden md:-mt-3 md:mb-3">
                      Arcade Games Emulator
                    </div>
                    <div className="hidden text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-1 sm:block">
                      Games Emulator
                    </div>
                    <div className="text-base text-white/70 pr-8 flex-grow sm:hidden md:text-sm">
                      Three iconic games —Who Wants to Be a Millionaire,
                      Whack-a-Mole, and Number Guesser —are brought together in
                      a single package.
                    </div>
                    <div className="hidden text-base text-white/70 pr-8 flex-grow sm:text-xs sm:pr-0 sm:scale-75 sm:origin-top-left sm:block">
            ...
            >
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-52 h-20 rounded-2xl overflow-hidden box-select-hover sm:scale-60 sm:origin-top md:scale-80 md:origin-top">
                <section className="flex items-center justify-center w-full h-full drop-shadow-md text-white gap-2">
                  ...
                  <img
                    src={
                      "https://img.icons8.com/sf-regular-filled/48/FFFFFF/right-squared.png"
                    }
                    alt="Right arrow"
                    className="w-8 h-8"
                  />
