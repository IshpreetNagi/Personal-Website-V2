    ...
    <div className="flex flex-col justify-start z-10">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 1.0 }}>
        <div className="flex flex-col justify-start z-10 overflow-hidden relative">
                      <div className="text-[52px] text-white mb-11 pl-20 sm:text-3xl sm:pl-16 sm:mb-8"> My Projects </div>

          <div className="flex flex-row gap-10 justify-center items-center flex-wrap max-w-[1600px] sm:gap-6 sm:max-w-[500px]">
            <a href="https://github.com/IshpreetNagi/Tempestuous-Turrets" target="_blank" rel="noopener noreferrer">
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-1">Tempestuous Turrets</div>
                    <div className="text-base text-white/70 pr-8 flex-grow sm:hidden">
                    ...
                    <div className="flex flex-row gap-3 mt-7 sm:-mt-2 sm:gap-1">
                ...
                <FaGithub className="w-4 h-4 text-white/20 sm:mb-1"/>
              </div>
            </a>
            ...
            <a href="https://github.com/IshpreetNagi/Personal-Website-V2" target="_blank" rel="noopener noreferrer">
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-2">This Website</div>
                    <div className="text-base text-white/70 pr-8 flex-grow sm:hidden">
                    ...
                    <div className="flex flex-row gap-3 mt-7 sm:-mt-3 sm:gap-1 sm:scale-90 sm:origin-left">
                      <div className="relative group inline-block">
                        <img
                ...
                <FaGithub className="w-4 h-4 text-white/20"/>
              </div>
            </a>
            ...
            <a href="https://github.com/IshpreetNagi/McMaster-Room-Booking-Portal" target="_blank" rel="noopener noreferrer">
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-2 sm:hidden">McMaster Room Booking</div>
                    ...
                    <div className="flex flex-row gap-3 mt-7 sm:-mt-2 sm:gap-1 sm:scale-75 sm:origin-left">
                      <div className="relative group inline-block">
                        <img 
                          src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg"
                          alt="Tailwind CSS Icon"
            ...
            <a href="https://github.com/IshpreetNagi/Arcade-Game-Emulator" target="_blank" rel="noopener noreferrer">
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-176 h-88 rounded-3xl overflow-hidden box-select-hover sm:w-68 sm:h-40 sm:rounded-2xl sm:px-4">
                <section className="flex items-center justify-start w-full h-full drop-shadow-md">
                  ...
                  <div className="flex flex-col overflow-auto text-left pl-8 text-white self-start py-7 sm:py-0 sm:pl-4 sm:overflow-hidden">
                    <div className="text-xl font-semibold mt-4 mb-8 sm:text-sm sm:mt-0 sm:mb-1 sm:hidden">Arcade Games Emulator</div>
                    ...
                    <div className="flex flex-row gap-3 mt-7 sm:-mt-2 sm:gap-1 sm:scale-60 sm:origin-left">
                      <div className="relative group inline-block">
                        <img 
            ...
            <a href="https://github.com/IshpreetNagi?tab=repositories" target="_blank" rel="noopener noreferrer">
              <div className="flex bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-6 w-52 h-20 rounded-2xl overflow-hidden box-select-hover sm:scale-60 sm:origin-top">
